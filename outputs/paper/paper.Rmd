...
The datasets were extracted using R [@citeR] and R packages opendatatoronto [@citeopendatatoronto], tidyverse [@tidyverse], dpylr [@dpylr] and knitr [@knitr]. The data was then processed, manipulated and analysed for the purposes of this paper. 
